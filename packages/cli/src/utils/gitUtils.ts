...
export const getLatestGitHubRelease = async (
  ...
  try {
    ...
    const endpoint = `https://api.github.com/repos/marizmelo/llm-cli/releases/latest`;
    ...
    console.debug(`Failed to determine latest llm-cli release:`, _error);
    throw new Error(
      `Unable to determine the latest llm-cli release on GitHub.`,
    );
  }
};
